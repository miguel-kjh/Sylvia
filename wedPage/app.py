...
def quickQuote():
    ...
    success=reqQuickQuote["success"],fail=reqQuickQuote["fail"],mean=round(array.mean(),2),std=round(array.std(),2))
...
def investment():
    ...
    success=reqInvestment["success"],fail=reqInvestment["fail"],mean=round(array.mean(),2),std=round(array.std(),2))
